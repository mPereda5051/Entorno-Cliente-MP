...
//Practica Unidad 6 Acceder a la etiqueta
const ocultar = document.getElementById("ocultar");
const hijo = document.body.firstElementChild;
const output = document.getElementById("output");

let elemento = null;
//añadimos lo que hace cada boton
...
duplicar.addEventListener("click", () => {
    ...
    //Practica Unidad 6 Crear etiqueta html Hay que darle dos veces al bototn para comprobar que si funciona.

    let div = document.createElement('div');

    div.className = "alert";

    div.innerHTML = "¡¡Aqui tienes tu objeto clonado!!.";

    document.body.append(div);

    //Practica Unidad 6 Modificar atributos
    output.textContent = document.body.getAttribute('something')

    document.body.setAttribute('something', 'En fin ignoremos que eso sucedio')
...
ocultar.addEventListener("click", ()=>{
    hijo.innerHTML = "Perdiste el juego, si quieres volver a intentaro recarga la pagina";
})
...
abrir.addEventListener("click", () => {
    ...
    if (llave && clave) {
        ...
        setTimeout(() => {
            //Practica Unidad 6 Uso de location
            location.assign("../Sala2/sala2.html");
        }, 1500);
    }
    else if (!llave) {
